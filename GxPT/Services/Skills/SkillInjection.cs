...
namespace GxPT
{
    ...
    internal static class SkillInjection
    {
        ...
        public const string Framing =
            ...
            + "listed in the host context as `- <slug> [<scope>] - <description>`. ALWAYS check that list "
            + "against the task before you start, and if any skill is relevant, open it with "
            + "open_skill({\"names\":[\"<slug>\"]}) and follow its instructions before taking any other "
